...
#   make dev     run stream (8790) + API (8787) + Vite dev server (5173) together
#   make serve   run the API serving the built web bundle (production)

.PHONY: setup native wasm web stream build test train dev serve clean
